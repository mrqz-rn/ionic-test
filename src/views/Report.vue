      ...
      <ion-content class="ion-padding">
        ...
        <div class="pa-4 pb-2 pt-3">
          ...
          <div class="d-flex" style="gap: 10px;">
            ...
            label="Date From" fill="outline" size="small" label-placement="stacked" 
            class="inputtext me-1"></ion-input>
            <ion-input v-model="displaydate.to" :readonly="true" @click="pickDate(2)"
            label="Date To" fill="outline"  label-placement="stacked" 
            class="inputtext me-1"></ion-input>
        ...
        <div class="pa-2" style="width: 97vw; max-height: 70vh; overflow-y: auto; overflow-x: hidden" >
            <table class="" width="100%">
              ...
              <tbody >
                <tr v-for="(data, key) in attlogs" :key="key">
                  <td class="text-center name">{{ data.EMPNAME }}</td>
