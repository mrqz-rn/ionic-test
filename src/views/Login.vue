<template>
    <ion-page class="backdrop">
        <div id="container" class="pa-6" style="margin-top: -10%">
          <div>
            <ion-img style="width: 28%; height: 28%; margin: auto;" src="/icon.png"/>
            <IonCardTitle class="pb-5" style="color: white; font-weight: 600; padding: 4%">STERLING PAPER GROUP ONLINE TIME TRACKER</IonCardTitle>
            <IonInput v-model="logindata.username" 
              ...
              class="mb-2 pb-1 custom inputtext">
            </IonInput>
            <IonInput v-model="logindata.password" type="password" label="Password" fill="outline" 
              ...
              style="text-align: left !important" class="custom inputtext" >
      ...
      async login(){
        ...
        try {
          ...
          if(response.status == true){
            ...
            // await loading.dismiss();
            // return this.showAlert({header: 'Alert', message: JSON.stringify(response)})
