<template>
  <IonPage id="main-content">
    ...
    <ion-toast 
      ...
      mode="ios"
      position="top" 
      :is-open="snackbar.status"  
      @didDismiss="snackbar.status = false"
            ...
            <ion-list v-else style="height: 45vh; overflow-y: auto;">
                <div class="d-block" >
                  ...
                  <div class="py-1 align-self-center">
                    <ion-button @click="viewLogs(data)" id="open-dialog" expand="block" shape="round" size="small">
          ...
          <div class="wrapper">
            ...
            <div class="pa-2 px-4 d-block" >
              ...
              <div v-if="inputrem == true">
                ...
                class="mt-2 inputtext" label="Remarks" fill="outline"  label-placement="stacked" 
...
const { DatetimeSetting  } = Plugins;
import { Camera, CameraResultType, CameraSource, CameraDirection } from '@capacitor/camera';
import { getPlatforms } from '@ionic/vue';
import { Device } from '@capacitor/device';
import { Geolocation } from '@capacitor/geolocation';
import { Network } from '@capacitor/network';
import { eye, book} from 'ionicons/icons';
...
export default {
  ...
  async created(){
    ...
    let timeDifference = nowtime - webtime;
    let differenceInMinutes = timeDifference / (1000 * 60);
    if (differenceInMinutes > 2) {
      this.showAlert({header: 'Warnig!', 
      message: "Your device datetime doesn't match with Philippine Standard Time. Please check your datetime settings.", 
      buttons: ['Okay']})
      ...
      buttons: ['Okay']})
        ...
        console.log('The current time is within 2 minutes of webtime.');
    }
  ...
  async validateSettings(){
        ...
        // const autotime = await DatetimeSetting.isAutoTimeEnabled()
        // if(autotime.value == false){
        //   this.setSnackBar(true, 'Set device time & date to automatic', 'danger')
        //   this.btnvalid = false
        this.settings = false
        //   this.$forceUpdate()
        //   return false
    ...
    getTimeDate(){
      ...
      this.display.time = now.toLocaleTimeString();
