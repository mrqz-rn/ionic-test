      ...
      <ion-content >
        <div class="pa-3" style="height: 80vh; overflow-y: auto;">
          <ion-card color="dark" class="pa-4" style="border-radius: 25px;">
            ...
            <h3 class="d-flex justify-center pt-2"  style="font-size: 2.3vh;">{{ user_info.username }}</h3>
            <h3 class="d-flex justify-center"  style="font-size: 2.1vh;">{{ user_info.EMPLNAM + ', ' + user_info.EMPFNAM + ' ' + user_info.EMPMNAM }} </h3>
          </ion-card>
          <div class="pa-2">
            <h3 class="text-center py-2" style="font-size: 2.7vh;">EMPLOYMENT INFORMATION</h3>
            <h3  style="font-size: 2.4vh;">Company:</h3>
            <h4 class="pb-2"  style="font-size: 2.1vh; color: #303030">{{ user_info.cmpname }}</h4>
            <h3 style="font-size: 2.4vh;">Department:</h3>
            <h4 class="pb-2" style="font-size: 2.1vh; color: #303030">{{ user_info.department }}</h4>
            <h3 style="font-size: 2.4vh;">Position:</h3>
            <h4 class="pb-2" style="font-size: 2.1vh; color: #303030">{{ user_info.posdesc }}</h4>
            <h3 style="font-size: 2.4vh;">Shift Schedule:</h3>
            <h4 class="pb-2" style="font-size: 2.1vh; color: #303030">{{ shift }}</h4>
          </div>
        </div>
        ...
        <div style="position: absolute; bottom: 0px; left: 0px; transform: translate(0%, 0%); width:100%;">
          ...
          <ion-modal id="example-modal" ref="modal" trigger="open-pass">
            <div class="wrapper">
              <h2 class="d-flex justify-center pt-2">Change Password</h2>
              <div class="pa-3" style="padding-right: 12px;">
                <IonInput v-model="password.old" type="password" label="Old Password" fill="outline" 
                  ...
                  style="text-align: left !important" class="custom mb-3 inputtext">
                ...
                <ion-button expand="full" color="primary" shape="round" @click="confirmPass()">Confirm</ion-button>
...
export default {
  ...
  computed: {
    shift(){
      let shfname = this.user_info.EMPSHFT
